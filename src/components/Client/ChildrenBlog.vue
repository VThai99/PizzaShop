<template>
  <div>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate2">
          ...
          <!-- .col-md-8 -->
          <div class="col-md-4 sidebar ftco-animate2">
            ...
            <div class="sidebar-box ftco-animate2">
