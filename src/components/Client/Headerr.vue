<template>
  <div>
    <div class="menu">
      <div class="btn trigger" @click="open">
        <span class="line"></span>
      </div>
      <div class="icons">
        <div class="rotater">
          <div class="btn btn-icon" @click="login">
            <i class="fas fa-sign-in-alt ba"></i>
          </div>
        </div>
        <div class="rotater">
          <div class="btn btn-icon" @click="logout">
            <i class="fas fa-sign-out-alt ba"></i>
          </div>
        </div>
        <div class="rotater">
          <div class="btn btn-icon">
            <i class="fab fa-facebook-f ba"></i>
          </div>
        </div>
        <div class="rotater">
          <div class="btn btn-icon">
            <i class="fab fa-twitter ba"></i>
          </div>
        </div>
        <div class="rotater">
          <div class="btn btn-icon">
            <i class="fab fa-dribbble ba"></i>
          </div>
        </div>
        <div class="rotater">
          <div class="btn btn-icon">
            <i class="fab fa-linkedin ba"></i>
          </div>
        </div>
        <div class="rotater">
          <div class="btn btn-icon">
            <i class="fab fa-github ba"></i>
          </div>
        </div>
        <div class="rotater">
          <div class="btn btn-icon">
            <i class="fab fa-behance ba"></i>
          </div>
        </div>
      </div>
    </div>
